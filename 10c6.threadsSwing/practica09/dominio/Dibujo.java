...
public class Dibujo
{
	...
	public Figura getFirstFigura(String grupo)
	{
		System.out.println(grupo);
		java.util.List<Figura> figurasGrupo = (java.util.List<Figura>)figuras.get(grupo);
		System.out.println(figurasGrupo);
		if(figurasGrupo!=null)
			return figurasGrupo.get(0);
		else
			return null;
	}
