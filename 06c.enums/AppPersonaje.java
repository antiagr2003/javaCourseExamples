public class AppPersonaje
{
	public static void main(String args[]) 
	{
		...
		Casa casa = new Casa(100, Material.LADRILLO); //Picará correctamente.
		System.out.println(casa.getInfo());
		personajes[0].picar(casa);
		//personajes[1].picar(new Casa(100, Casa.LADRILO));  //Ahora dará error de compilación ya que no existe ningún atributo de lcase llamado así.
