...
public class JVentanaDibujo extends JFrame implements Runnable
{
	...
	public JVentanaDibujo()
	{
		...
		JButton btnAnimacion = new JButton("Animacion");

		btnAnimacion.addActionListener(e ->
					{
						Thread hilo = new Thread(JVentanaDibujo.this);
						hilo.start(); //Envío al planificador: scheduler
					});
		pnlNorte.add(btnAnimacion);
	...
	public void run()
	{
		Circulo c = new Circulo(100, 1, true, Color.RED, 30);
		dibujo.addFigura("Grupo Global", c);
		lienzo.repaint();
