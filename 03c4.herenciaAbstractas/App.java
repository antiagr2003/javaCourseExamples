	...
	public static void main(String args[]) 
	{
		...
		for(Personaje p:personajes)
			if(p != null && p instanceof PersonajePremium)
			{
				...
				System.out.println("La skin del objeto del tipo Premium es " 
					+ personajePremium2.getSkins());
			}	


		Clonable clonables[] = new Clonable[10];
		clonables[0] = new PersonajePremium(10, 10, "skin");
		/*clonables[1] = new Figura(10, 10);
		clonables[2] = new Robot("sasasasa");*/
		
		System.out.println(clonables[0].clonar());
