...
public class JVentanaDibujo extends JFrame
{
	...
	private Color validarColores() throws NumberFormatException, RGBConversionException
	{
	...
	private void inicializarCreacionFigura(MouseEvent me)
	{
		xInicial = me.getX();
		yInicial= me.getY();
