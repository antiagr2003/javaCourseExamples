package practicaFinal.crawlers;
/*
...
import practicaFinal.ui.JVentanaScrapping;

public class WebScrappingMarca extends Thread
{
	private JVentanaScrapping ventana;

	public WebScrappingMarca(JVentanaScrapping ventana)
	{
	...
	public void run()
	{
		...
		try
		{
			...
			for(Element noticia:noticias)
				...
				ventana.actualizarNoticia("Marca: " + noticia.text());
		}
		catch(IOException e)
		{
